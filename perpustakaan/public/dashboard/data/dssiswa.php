...
<body>
    ...
    <table border="1">
        ...
        <a href="../../siswa/view/cetak.php"> Cetak |</a>
                ...
                <?php 
                    while ($userAmbilData = mysqli_fetch_array($ambildata)) {
                        echo "<tr>";
                            ...
                            echo "<td>" . $namasiswa = $userAmbilData['nama'] . "</td>";
                        ...
                        echo "<td> 
                                ...
                                <a href='../../siswa/view/update.php?id=" . $userAmbilData['idsiswa'] . "'>Edit</a> |
                                <a href='../../siswa/controller/siswahapus.php?id=" . $userAmbilData['idsiswa'] . "'>Hapus</a>
                            </td>";
                        echo "</tr>";
                    }
                ?>
